...
const footer = () => {
  return (
    <div className="w-full h-[80px] bg-gray py-12">
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">

      </div>
      <div className="md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-2 max-w-[600px]  px-3 md:px-0">
        ...
        <div>
          ...
          <ul className="py-6 text-[#6D737A]">
            <li className="py-2">CV Builder</li>
            <li className="py-2">CV Templates</li>
            <li className="py-2">CV Examples</li>
            <li className="py-2">CV Format</li>
            <li className="py-2">Lifestyle</li>
            <li className="py-2">How to Write a CV</li>
            <li className="py-2">CV Help</li>
          </ul>
        </div>
        ...
        <div className="max-[780px]:col-span-2">
          ...
          <form className="py-4">
            ...
            />
            <button className="max-[780px]:w-full my-4 px-5 py-3 rounded-md bg-[#e8f0ed] font-medium">
